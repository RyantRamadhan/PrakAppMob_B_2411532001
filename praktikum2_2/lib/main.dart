        ...
        Card(
          ...
          child: Column(
            children: [
              ...
              // Transaksi Fiktif 1 (Pengeluaran)
              ListTile(
                leading: const CircleAvatar(
                  backgroundColor: Colors.orange,
                  child: Icon(Icons.delivery_dining, color: Colors.white),
                ),
                title: const Text('GrabFood: Mie Gacoan'),
                subtitle: const Text('16 Sep 2026'),
                trailing: const Text(
                  '- Rp 45.000',
                  // TUGAS 1: Styling teks pengeluaran menjadi merah
                  style: TextStyle(
                    color: Colors.red,
                    fontWeight: FontWeight.bold,
                  ),
              ...
              // Transaksi Fiktif 2 (Pemasukan)
              ListTile(
                leading: const CircleAvatar(
                  backgroundColor: Colors.teal,
                  child: Icon(Icons.computer, color: Colors.white),
                ),
                title: const Text('Honor Proyek Web'),
                subtitle: const Text('18 Sep 2026'),
                trailing: const Text(
                  '+ Rp 750.000',
                  // TUGAS 1: Styling teks pemasukan menjadi hijau
                  style: TextStyle(
                    color: Colors.green,
                    fontWeight: FontWeight.bold,
                  ),
